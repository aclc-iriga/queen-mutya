...
$routes = [
    [ "name" => "Tabulation"            , "route" => "/queen-mutya"          ],
    ...
    [ "name" => "Top 5 (Queen)"         , "route" => "results/top5-queen"    ],
    [ "name" => "Top 5 (Mutya)"         , "route" => "results/top5-mutya"    ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >queen-mutya</h1>
                <p class="fst-italic" >Arriba Plaza Queen & Mutyang Pangkalawakan (Iriga City)</p>
            </div>
